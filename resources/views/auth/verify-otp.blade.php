                  ...
                  <span class="app-brand-logo demo">
                    ...
                    >
                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('auth.verify.otp', ['id' => $id]) }}" method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-primary d-grid w-100">Submit Now</button>
                        </form>
